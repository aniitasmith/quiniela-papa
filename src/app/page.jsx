          ...
          <div>
            ...
            <div className="text-center mb-5">
              ...
              <p className="text-gray-500 text-sm mt-2">
                Equipos en <span className="text-green-700 font-bold">verde</span> clasificarían · toca un partido para anotar el resultado real
              </p>
            </div>
                  ...
                  <div key={g} className="bg-white rounded-2xl shadow-md overflow-hidden border-2 border-green-100">
                    <div className="bg-green-700 px-4 py-3 flex items-center gap-2">
                      ...
                      {groupPlayed > 0
                        ...
                        : <span className="ml-auto text-green-200 text-sm font-medium">Pts quiniela</span>
                      }
                    </div>
                    {ranked.map((t, i) => (
                    ...
                    <div className="border-t-2 border-green-100">
                      <div className="bg-green-50 px-4 py-2">
                        <span className="text-xs font-bold text-green-700">⚽ PARTIDOS · toca para anotar el resultado real</span>
                      </div>
                      {gMatches.map((m, mi) => {
                        const real = realResults[matchKey(m)];
                        ...
                        return (
                          ...
                          >
                            ...
                            {real ? (
                              ...
                              <span className="text-xs text-gray-300 ml-auto shrink-0">~{projPts} pts proyectados</span>
                            )}
                          </button>
                        );
                      })}
